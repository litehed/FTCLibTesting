...
public class MecanumDrive extends RobotDrive {
    ...
    public void driveWithMotorPowers(double frontLeftSpeed, double frontRightSpeed,
        ...
        motors[MotorType.kFrontLeft.value].set(frontLeftSpeed);
        motors[MotorType.kFrontRight.value].set(frontRightSpeed);
        motors[MotorType.kBackLeft.value].set(backLeftSpeed);
        motors[MotorType.kBackRight.value].set(backRightSpeed);
    }
